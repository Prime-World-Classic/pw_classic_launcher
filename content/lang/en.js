export const en = {
  ...
  word: {
    ...
    save: "Save",
    soundHelp:
      "If the sound settings are lost, you can adjust the volume in the mixer: right-click on the sound icon on the Taskbar -> Volume Mixer -> Game icon -> make it quieter",
    support: "Support",
    ...
    settingsNativeApiNotInitialized:
      "NativeAPI not initialized! Using default settings",
    ...
    mmCheck: "Check",
    mmLauncherDownload:
      'Download and install the latest Windows version of the <a href="https://pw.26rus-game.ru/" class="launcher-link">launcher</a> just once, now you won\'t need to perform any additional actions to update the game, the launcher will do everything automatically.',
    mmWindowsLauncherRequired: "Windows launcher version required!",
    mmBrowserSupportDiscontinued:
      "We have discontinued browser-based matchmaking and Prime World game launch as players regularly encountered issues with it.",
    ...
    connectionClosedError:
      "Connection closed... Reconnecting in progress, please wait... [{count}]",
    ...
    requestAlreadyPending:
      "Request already pending, please wait for server response (15 seconds)... | {method} -> {object}",
    requestFailedConnectionError: "Request failed, internet connection error",
    requestTimeoutError:
      "Internet connection error, request timeout for {object} -> {method}",
    ...
    talentConflict:
      "The selected talent conflicts with another talent in the build!!",
    smartcastDescription:
      "Right-click a talent in this bar to enable/disable smartcast (use skill without confirmation)",
    ...
    enableMic:
      "Press Ctrl+Z or click your Nickname to enable: {Voice.mic.label}",
    ...
    frame_12: "Winter frame",
    frame_16: "Spring frame",
    frame_20: "Cave frame",
    frame_24: "Autumn frame",
    ...
    titleafk: "OK",
    titleafk1:
      "One of the party participants was AFK, so you are excluded from the match selection",
    titleafk2: "You have been excluded from matchmaking for AFK!",
    titleClickToViewHeroRating:
      "Click here to select a hero and sort hall of fame players",
    ...
    htalent_1_description:
      "With a <num>25%</num> chance, the hero ignores <num>%s</num> damage (based on the higher of Strength or Intellect), but no more than <num>30%</num>.",
    htalent_2_name: "Chains of Ice",
    htalent_2_description:
      "Damage from the hero's class talents reduces enemies' Speed by <num>6%</num>(<num>36%</num>) and Agility by <num>%s</num>(<num>%s</num>) (based on the higher of Strength or Intellect) for <num>3</num> sec.<br>The effect stacks up to <num>6</num> times.<br><rz>When using class abilities from native terrain, receiving damage from them burns <num>1.5%</num> of the enemy's Energy.</rz>",
    htalent_3_name: "Deathblow",
    htalent_3_description:
      "All of the hero's class talents can deal critical damage. Damage from attacks and Blades of Darkness that reduces an enemy's Health below <num>%s</num> (based on the higher of Strength or Intellect) kills them.<br><rz>After dealing a critical hit on native terrain, the hero restores <num>%s</num> Health based on Intellect.</rz>",
    htalent_4_name: "Commander",
    htalent_4_description:
      "For <num>5</num> sec., each ally near the hero increases their Stamina and Will by <num>%s</num> (based on Strength).<br>The effect stacks up to <num>4</num> times.",
    htalent_5_name: "Chain Lightning",
    htalent_5_description:
      "Using a class talent that deals lightning damage allows the hero's attacks to hit one additional enemy. Each subsequent lightning deals <num>20%</num> less damage than the previous one. The effect lasts <num>15</num> sec. and stacks up to <num>5</num> times.",
    htalent_6_name: "Cover",
    htalent_6_description:
      "While under Cover, the hero additionally gains <prime>10</prime> when an enemy soldier or creature dies nearby.<br>The hero automatically becomes invisible if they don't deal any damage for <num>12</num> sec.<br><rz>On native terrain, the hero becomes invisible <num>4</num> seconds faster.</rz>",
    htalent_7_name: "Beast Rush",
    htalent_7_description:
      "The hero and wolves have a <num>15%</num> chance to attack twice.",
    ...
    htalent_24_description:
      "While near a tree or mushroom, the hero spends <num>2</num> times less Energy on class talents, and their attacks and Roots of Evil steal <num>%s</num> Health (based on the higher of Strength or Intellect).<br>Evilwood is also considered a tree.",
    htalent_25_name: "Etherlord",
    htalent_25_description:
      "<mag></mag> damage dealt to enemies around the hero is increased by <num>10%</num>.<br>Killing an enemy hero or <num>20</num> enemy units increases the hero's maximum Energy by <num>%s</num>(<num>%s</num>) (based on Intellect).<br>The effect stacks <num>10</num> times.",
    htalent_26_name: "Inspiration",
    htalent_26_description:
      "The color of notes around the hero indicates which talent to use. Using the indicated talent gives the hero <prime>10</prime> and <num>1</num> Inspiration, which stacks up to <num>20</num> times, and increases their Speed by <num>0.5%</num> per Inspiration for <num>3</num> sec.",
    htalent_27_name: "Multihanded Warrior",
    htalent_27_description:
      "In response to an enemy attack, the hero has a <num>20%</num> chance to hit all nearby opponents with their next strike, with Health and Energy steal occurring from no more than <num>3</num> targets.",
    htalent_28_name: "Enchanted Tome",
    htalent_28_description:
      "Casting class talents is not interrupted by movement or exceeding distance to the target.<br>Upon taking damage exceeding <num>10%</num> of current Health, class talent cast time is reduced by <num>20%</num> for <num>4</num> sec.<br>The effect stacks up to <num>3</num> times.",
    htalent_29_name: "Winged",
    htalent_29_description:
      "Taking or dealing damage increases Speed by <num>20%</num> for <num>3</num> sec.",
    htalent_30_name: "Heroism",
    htalent_30_description:
      "Upon taking damage equal to <num>10%</num> of maximum Health, the hero increases their Stamina and Will by <num>0.5</num> and an additional <num>%s</num> (based on the higher of Strength or Intellect) for <num>12</num> sec.<br>The effect stacks up to <num>10</num> times.",
    ...
    htalent_33_description:
      "The hero restores Health equal to <num>13%</num> of damage dealt by attacks and class talents, but uses Health instead of Energy to activate them. The hero's Health is increased by <num>%s</num> of their maximum Energy.<br><rz>When used from native terrain, class talents consume <num>30%</num> less Health.</rz>",
    htalent_34_name: "Witch's Curse",
    htalent_34_description:
      "Opponents damaged by the hero's attacks and class talents take <num>15%</num> more damage for <num>3</num> sec.<br><rz>From native terrain, attacks against cursed targets steal <num>%s</num> Energy from the enemy (based on the higher of Strength or Intellect).</rz>",
    htalent_35_name: "Symbol of Faith",
    htalent_35_description:
      "Successful use of a class talent accumulates <num>1</num> charge of faith. Using a class talent at <num>3</num> charges of faith is accompanied by an additional effect, but spends all charges.<br>\n<rz>On native terrain, the hero's Health regeneration increases by <num>%s</num> (based on the higher of Strength or Intellect) if they haven't taken damage from enemy heroes for <num>5</num> sec.</rz>",
    ...
    htalent_39_description:
      "The Dirty Fighting talent additionally stuns the main target for <num>1.3</num> sec.",
    htalent_40_name: "Daring Onslaught",
    htalent_40_description:
      "The Flurry of Blows talent also increases the hero's Speed by <num>40%</num>.",
    ...
    htalent_44_description:
      "The hero's attacks and Trick Blade flashes deal <num>15%</num> more damage.",
    htalent_45_name: "Blizzard &#x1F4A7 180 ⌛️8",
    htalent_45_description:
      "Creates an area for <num>8</num> sec. where enemies take <mag>%s</mag> damage per sec.",
    htalent_46_name: "Impenetrable Cold",
    htalent_46_description:
      "Enemies attacking the hero take <mag>%s</mag> damage (based on the higher of Strength or Intellect).",
    ...
    htalent_48_description:
      "Deals <mag>%s</mag> damage to the specified enemy over <num>5</num> sec.",
    htalent_49_name: "Cold Calculation",
    htalent_49_description:
      "Every <num>5</num> sec., the hero's next attack deals an additional <fiz>%s</fiz> damage (based on Strength).",
    ...
    htalent_51_description:
      "The Ice Shard talent deals additional damage to slowed enemies.</br>\nThe lower the enemy's Speed, the more damage they take.",
    ...
    htalent_59_description:
      "Cooldown time and Energy cost of the Shimmer talent are reduced by <num>50%</num>. If the hero takes damage while the talent is on cooldown, the current cooldown time is increased by <num>2</num> times. The damage-taking effect can only trigger once after each use of the Shimmer talent.",
    ...
    htalent_63_description:
      "The Chieftain's Strike talent also reduces enemies' Stamina by <num>%s</num> (based on Stamina) for <num>10</num> sec.",
    ...
    htalent_67_description:
      "The effect of the Charmed Armor talent reduces damage dealt to the hero by <num>20%</num>.",
    ...
    htalent_74_description:
      "The Thunderclap talent additionally deals <fiz>%s</fiz> damage per <num>1</num> Chain Lightning.<br>After Thunderclap's cooldown, additional damage cannot be dealt for <num>5</num> sec. per <num>1</num> Chain Lightning.<br>A five-stack hammer deals <fiz>%s</fiz> damage.",
    ...
    htalent_76_description:
      "The Heaven's Wrath talent additionally deals <fiz>%s</fiz> damage.",
    ...
    htalent_80_description:
      "The Dance of Fans talent accumulates <num>4</num> more fans. The last <num>2</num> fans do not increase Energy consumption.",
    ...
    htalent_84_description:
      "The Invisible Help talent affects all allied heroes, even if they are not near the heroine.",
    ...
    htalent_87_description:
      "Each attack by a wolf summoned by Wolf Call reduces the enemy's speed by <num>25%</num> for <num>3</num> sec.",
    htalent_88_name: "Curse of the Piercing Spear",
    htalent_88_description:
      "For <num>8</num> sec., each hit on the target restores <num>%s</num> Health to the attacker (based on the higher of Strength or Intellect). Wolves additionally restore health to the hero.",
    ...
    htalent_90_description:
      "Wolf Call summons two wolves, but requires <num>75</num> more Energy.",
    ...
    htalent_95_description:
      "The turret becomes invisible if it doesn't attack for <num>3</num> sec. The turret's critical damage chance increases by <num>20%</num>.",
    ...
    htalent_99_description:
      "Enemies taking damage from Time Bomb are launched into the air.",
    htalent_100_name: "Stamping",
    htalent_100_description:
      "While near a vita-generator, the hero gains 1<detail></detail> more per second.",
    ...
    htalent_111_description:
      "Hero Strike stuns the nearest enemy hero for <num>1</num> sec.",
    ...
    htalent_114_description:
      "Hero Strike slows the enemy by <num>70%</num> for <num>2.5</num> sec.",
    ...
    htalent_116_description:
      "The hero's Speed increases by <num>6%</num> for each Battle Thirst effect.",
    ...
    htalent_118_description:
      "When dealing damage with class talents, the hero restores <num>%s</num> Health (based on Strength).",
    ...
    htalent_121_description:
      "The Unstoppable talent additionally restores <num>4%</num> of the hero's missing Health.",
    ...
    htalent_123_description:
      "The Fist of Fury talent additionally stuns the target for <num>0.5</num> sec.",
    ...
    htalent_125_description:
      "Deals <mag>%s</mag> damage to enemies in front of the hero.",
    ...
    htalent_128_description:
      "The Fox Trick illusion, <num>2</num> sec. after appearing, stuns all nearby enemies for <num>1.4</num> sec.",
    ...
    htalent_130_description:
      "The Wind and Sparks talent's cooldown is reduced by <num>2</num> sec. for each target it damages.",
    htalent_131_name: "Fire Shield",
    htalent_131_description:
      "During the use of the Firetail talent, the hero takes <num>40%</num> less damage.</br>\r\n<rz>When used from native terrain, restores <num>6%</num> of maximum Health per second.</rz>",
    htalent_132_name: "Playing with Fire",
    htalent_132_description:
      "The Burning effect from the Soul Harmony talent stacks <num>2</num> times more.",
    htalent_133_name: "Healing <mana>80</mana>		<CD>4</CD>",
    htalent_133_description:
      "Restores <num>%s</num> Health (based on Intellect) to the target and <num>%s</num> to the hero themselves.",
    ...
    htalent_135_description:
      "If the Healing talent does not affect allied heroes, it refunds <num>50%</num> of the Energy spent and cools down <num>50%</num> faster.",
    ...
    htalent_138_description:
      "The Healing talent additionally restores <num>%s</num> Health to all allies near the target.",
    ...
    htalent_140_description:
      "Triumph of Life additionally heals <num>2</num> allied heroes around.",
    ...
    htalent_143_description:
      "Slashing Throw additionally deals <mag>%s</mag> damage. After hitting the target, the disc bounces to <num>4</num> nearest enemies, dealing <mag>%s</mag> damage to each.<br><br><col3>Of One Flesh: Deals <fiz>%s</fiz> damage.</col3>",
    htalent_144_name: "Predator",
    htalent_144_description:
      "The Feed the Panther talent restores <num>%s</num> more Health (based on Intellect).<br> For <num>3</num> sec. after using Slashing Throw, damage dealt to the panther is reduced by <num>10%</num>.<br><br><col3>Of One Flesh: Restores <num>%s</num> Health (based on Strength).</col3>",
    ...
    htalent_150_description:
      "A strike that launches enemies around and deals <mag>%s</mag> damage to them (based on maximum Health).",
    htalent_151_name: "Living Stone",
    htalent_151_description:
      "While sheltered in boulder form, the hero can use the Shockwave talent.",
    htalent_152_name: "Giant's Stride",
    htalent_152_description:
      "Reduces the Speed of all nearby enemies by <num>18%</num>.",
    ...
    htalent_154_description:
      "The Shockwave talent deals additional damage to slowed enemies. The lower the enemy's Speed, the more damage they take.",
    htalent_155_name: "Deadly Avalanche",
    htalent_155_description:
      "Enemies hit by Avalanche lose <num>50%</num> Speed for <num>8</num> sec.",
    htalent_156_name: "Trembling Step",
    htalent_156_description:
      "Giant's Stride additionally reduces enemies' Speed by <num>8%</num>.",
    htalent_157_name: "Devious Throw &#x1F4A7 90 ⌛️7",
    htalent_157_description:
      "Deals <fiz>%s</fiz> damage to the first enemy in its path.",
    ...
    htalent_160_description:
      "The first attack during Shadow Warrior stuns the enemy for <num>1</num> sec.",
    ...
    htalent_167_description:
      "The Balance of Power talent deals <num>2</num> times more damage to enemy heroes.</br>\n<rz>When used from native terrain, allied heroes also gain <num>30%</num> Speed for <num>7</num> sec.</rz>",
    htalent_168_name: "Conquest",
    htalent_168_description:
      "The Bewitchment talent also reduces enemies' Will by <num>%s</num> for <num>6</num> sec. (based on Will).",
    htalent_169_name: "Tranquility",
    htalent_169_description:
      "An aura that increases the Will of allied heroes by <num>%s</num> (based on Will).",
    htalent_170_name: "Disturbance of Peace",
    htalent_170_description:
      "Enemies within the Tranquility aura's area take <mag>%s</mag> damage each time the talent is used.",
    ...
    htalent_172_description:
      "The Rainbow Flight talent lasts <num>5</num> sec. longer.",
    ...
    htalent_178_description:
      "The Hunt's fervor talent also increases the specified allied target's Agility by <num>%s</num> (based on Intellect) and the hero's own Agility by <num>%s</num> (based on Intellect).<br><rz>On native terrain, Agility is additionally increased by <num>%s</num>.</rz>",
    ...
    htalent_180_description:
      "The Hunt's fervor talent benefits both the hero and the specified ally.",
    ...
    htalent_183_description:
      "Each hit on the Ghost Shield restores <num>%s</num> Energy to the hero (based on Intellect).",
    ...
    htalent_187_description:
      "The Ghost Lash talent restores <num>%s</num> more Health per sec. (based on Intellect).<br>Total restores <num>%s</num> Health (based on Intellect). <br> The hero gains <num>30%</num> Speed, and the ally gains <num>20%</num>.",
    ...
    htalent_192_description:
      "When the Flute's Call talent ends, it deals <mag>%s</mag> damage to the charmed hero (based on Intellect).",
    ...
    htalent_199_description:
      "Enemies damaged by the Shredding Volley talent have their Speed reduced by <num>50%</num> for <num>4</num> sec.",
    htalent_200_name: "Active Defense",
    htalent_200_description:
      "Using the Redeployment talent grants the hero a shield for <num>5</num> sec. that absorbs up to <num>%s</num> damage (based on Strength) and <num>%s</num> damage (based on Intellect).",
    htalent_201_name: "Targeted shooting",
    htalent_201_description:
      "The hero's attacks deal additional <fiz>%s</fiz> and <mag>%s</mag> damage, but not exceeding <num>2.2%</num> of the target's maximum Health.",
    ...
    htalent_206_description:
      "Health Regeneration increases by <num>%s</num> (from Intellect).<br>\n<rz>In the native land, the increase in Health regeneration is additionally increased by <num>%s</num>.</rz>",
    htalent_207_name: "Predator's Excitement",
    htalent_207_description:
      "The Wild Beast talent additionally enhances the hero's attacks by <mag>%s</mag> damage for every <num>10%</num> missing Health of the enemy hero nearby.",
    ...
    htalent_211_description:
      "Animal Sense activation also increases Agility by <num>%s</num> (from Intellect).",
    ...
    htalent_214_description:
      "Finishing off an enemy with an attack, the hero restores <num>%s</num> Health.",
    ...
    htalent_216_description:
      "Swallow your Talent! additionally replenishes <num>%s</num> of energy.",
    htalent_217_name: "Grab it! &#x1F4A7 100 ⌛️18",
    htalent_217_description:
      "Attracts the first enemy on the attack path to the hero.",
    ...
    htalent_219_description:
      "Grab your Talent! additionally stuns a captured enemy for <num>1.5</num> seconds.",
    ...
    htalent_221_name:
      "The Roots of Evil &#x1F4A7 50 ⌛️3 /|font color=#8CD5FF> ⌛️8</font>",
    ...
    htalent_222_name:
      "Living skin &#x1F4A7 60 ⌛️30 /|font color=#8CD5FF> ⌛️5</font>",
    ...
    htalent_225_name:
      "Crow's Evil Eye &#x1F4A7 120 ⌛️25 /|font color=#8CD5FF> ⌛️5</font>",
    ...
    htalent_227_description:
      "Each attack of the crow with a chance of <num>50%</num> blinds the target for <num>2</num> seconds.",
    ...
    htalent_232_description:
      "In Ethereal form, the hero, passing by enemies, deals them <mag>%s</mag> damage.",
    ...
    htalent_235_description:
      "Increases its Speed in ethereal form by <num>50%</num>.",
    ...
    htalent_240_description:
      "Talent Combat motive does not allow targets to use talents for <num>1</num> sec.",
    htalent_241_name: "Slow rhythm",
    htalent_241_description:
      "Heroes under the Triumphant Motif effect gain <num>%s</num> to the greatest of Strength and Intellect (from Cunning) for <num>7</num> seconds.\n",
    ...
    htalent_249_description:
      "With a <num>20% chance</num>, the hero dodges the enemy's attack.",
    ...
    htalent_251_description:
      "Each poisoning effect additionally reduces the enemy's Cunning by <num>%s</num> (from Will).",
    ...
    htalent_256_description:
      "The Transformation talent deals <fiz>%s</fiz> more damage.\n<br>Total damage: <fiz>%s</fiz>",
    ...
    htalent_259_description:
      "Enemies inside the Energy Barrier take <fiz>%s</fiz> damage per second.",
    htalent_260_name: "Demonic Fire",
    htalent_260_description:
      "Enemies located near the Summoned Demon receive <mag>%s</mag> damage per second.",
    ...
    htalent_266_description:
      "Released Warrior Fairies deal <fiz>%s</fiz> damage, and Guardian Fairies deal <mag>%s</mag> damage.",
    htalent_267_name: "Epiphany",
    htalent_267_description:
      "Increases the effectiveness of class talents by <num>25%</num> for the duration of the Unity talent.",
    ...
    htalent_273_description:
      "The hero can use the Decisive Attack talent <num>1</num> times more.",
    ...
    htalent_275_description:
      "The Bodyguard talent additionally increases the hero's own Speed by <num>50%</num> for <num>5</num> seconds.",
    ...
    htalent_279_description:
      "This caustic substance creates an area that gradually increases in size.",
    ...
    htalent_282_description:
      "Enemies trapped at the beginning of Portia Glue's talent cone cannot use talents for <num>2.5</num> seconds.",
    ...
    htalent_284_description:
      "Talent Recovery Time Mercury's Power is reduced by <num>40%</num>.",
    ...
    htalent_287_description:
      "By hitting a trap with a whip, the hero removes a new archon from it, reducing the recovery time of the Demon Trap talent by <num>50%</num> and restoring the Energy spent on the trap, and hitting an already summoned one increases his maximum Health by <num>%s</num> (from the greatest of Strength and Intellect).",
    htalent_288_name: "The Horror of the Trap",
    htalent_288_description:
      "Immobilized with the help of the Demon Trap talent, the hero cannot use talents. Enemy heroes who were near the target when completing the immobilizing effect of the Demon Trap cannot use talents for <num>2</num> seconds.",
    ...
    htalent_290_description:
      "The Inner Flame also increases the Archon's attack range and Power by <num>%s</num> (from Intellect).",
    ...
    htalent_294_description:
      "The hero throws a scarlet rose, dealing <mag>%s</mag> damage to all enemies in his path.",
    htalent_295_name: "Deep Cut",
    htalent_295_description:
      "The Blood Stroke talent deals additional <fiz>%s</fiz> damage and restores <num>%s</num> more Health.",
    ...
    htalent_299_description:
      "Being in the area created by the Concealing Mist talent, the hero takes <num>30% less damage</num>.",
    ...
    htalent_303_description:
      "The familiar additionally inflicts <fiz>%s</fiz> for <num>6</num> seconds, opens visibility and can fly further away from the hero.<br>\Terrible damage: <fiz>%s</fiz>",
    htalent_304_name: "A trace of horror",
    htalent_304_description:
      "By applying the Magic Boost talent for the initial cost, the hero leaves a trail for <num>1.5</num> seconds for <num>2</num> seconds, in which enemies panic.",
    ...
    htalent_308_description:
      "Talent target The Curse of Fragility panics for <num>3</num> sec.",
    ...
    htalent_311_description:
      "Using the Fragmentation Grenade talent, the hero accelerates by <num>40%</num> for <num>3</num> seconds.",
    htalent_312_name: "Violent pressure",
    htalent_312_description:
      "The Desperate Dash talent also throws up enemies.",
    ...
    htalent_315_description:
      "While the Healing Light talent is being restored, the greatest of the hero's Stamina and Will is increased by <num>%s</num> (from the greatest of Strength and Intellect).",
    ...
    htalent_318_description:
      "By applying the Ignition talent, the hero accelerates by <num>40%</num> for <num>3</num> seconds.",
    ...
    htalent_321_description:
      "The Swift Attacks talent acts <num>4</num> times, increases the hero's cunning by <num>%s</num> (from the greatest of Strength and Intellect) for each effect of Swift Attacks and lowers the target's Will by <num>%s</num> (from Intellect) for <num>5</num> seconds.<br>The effect of lowering the Will adds up to <num>4</num> times.",
    htalent_322_name: "Cocoon",
    htalent_322_description:
      "Applying the talent of Undermining for <num>7</num> seconds creates a cocoon. Repeated use of the talent moves the hero into a cocoon if he is not destroyed.",
    ...
    htalent_327_description:
      "All allied heroes receive <num>%s</num> Energy regeneration (from the greatest of Strength and Intellect).",
    ...
    htalent_329_name:
      "Light of the Spirit &#x1F4A7 100 <mag>⌛️10</mag><fiz>⌛️15</fiz>",
    ...
    htalent_330_description:
      "The hero gains control immunity and damage reduction by <num>50%</num> for <num>7</num> seconds.",
    ...
    htalent_335_description:
      "Restores all class talents of the hero, except for the ultimate.",
    ...
    htalent_339_description:
      "The Frost Onslaught talent additionally stuns wounded enemies for <num>0.4</num> sec.",
    htalent_340_name: "Chilling Bonds",
    htalent_340_description:
      "Any damage to a target enclosed in a Ring of needles restores <num>50%</num> more Health to the hero, but not more than <num>%s</num> (of Strength) in total.",
    ...
    htalent_343_description:
      "After each hero attack, the Icy Strikes talent additionally reduces the current cooldown time of class talents by <num>0.5</num> sec.",
    ...
    htalent_349_description:
      "The number of attacks per second increases by <num>50%</num>.",
    ...
    htalent_357_description:
      "The recovery time of the Swift Capture talent is reduced by <num>1%</num> for every <num>1%</num> of missing Health.",
    htalent_358_name: "Ruthlessness",
    htalent_358_description:
      "Each effect of the Destructive Strikes talent increases the hero's speed by <num>10%</num>.",
    ...
    htalent_361_description:
      "The Fury of battle additionally increases the greatest of the hero's Stamina and Will by <num>%s</num> (of Intellect) for every <num>5%</num> of missing Health.",
    ...
    htalent_375_description:
      "Every <num>12</num> seconds, the next bear attack additionally deals <mag>%s</mag> damage, stuns the target for <num>0.7</num> seconds and marks it for <num>3</num> seconds.",
    ...
    htalent_379_description:
      "Enemies slowed down by Border guard talent cannot become invisible.<br>Talent recovers by <num>9</num> seconds faster, and triggering a trap increases the hero's Speed by <num>30%</num> by <num>4</num> seconds.",
    ...
    htalent_388_description:
      "The Serenity talent's recovery time is reduced by <num>9</num> seconds.",
    ...
    htalent_393_description:
      "Allows the hero to apply the Somersault talent once more.",
    ...
    htalent_397_description:
      "Using the Milkshake talent reduces damage by <num>40%</num> for <num>6</num> seconds.",
    ...
    htalent_402_description:
      "Iron Accuracy Talent deals <num>50%</num> more damage and stuns the target for <num>0.5</num> sec.",
    ...
    htalent_406_description:
      "Enemies on the border of a Ferocious Hurricane receive additional <fiz>%s</fiz> damage per second.",
    htalent_407_name: "Steel Leash",
    htalent_407_description:
      "Enemies trapped in Shackles are attracted closer to the hero and receive <fiz>%s</fiz> damage per second.",
    ...
    htalent_412_description:
      "Fire Talent slows down enemies by <num>40%</num> for <num>4</num> seconds. Deceleration decreases by <num>5%</num> per second to <num>20%</num>.",
    htalent_413_name: "Fire Curse",
    htalent_413_description:
      "The target of the hero's attacks or class abilities takes <mag>%s</mag> damage after <num>2</num> seconds.",
    htalent_414_name: "Hail of Fire",
    htalent_414_description:
      "Firestorm talent deals <num>50% more damage</num>. Total <mag>%s</mag>.",
    htalent_415_name: "Exuding heat",
    htalent_415_description:
      "An enemy struck by a Fire Curse deals <mag>%s</mag> damage to all enemies around him for <num>2</num> seconds and restores Aggels <num>%s</num> Health (from Intellect) at the end of the effect.",
    htalent_416_name: "Flaming",
    htalent_416_description:
      "The hero spends charges on moving with the help of his talent On burnt wings. The hero receives <num>1</num> charge every <num>14</num> seconds, but no more than <num>3</num> in total.<br>\The talent recovery time On burnt wings is reduced to <num>3</num> seconds.",
    ...
    htalent_420_description:
      "The hero in the Fast Attack stance slows down his attack by <num>30%</num> for <num>3</num> seconds after moving to the target of his attack.<br>\n<num>+%s</num> Agility (from Intellect).",
    ...
    htalent_422_description:
      "In this stance, the hero takes <num>15%</num> less damage.",
    ...
    htalent_424_description:
      "In the Enhanced Defense stance, the hero receives a speed increase of <num>40%</num>.<br><num>+%s</num> to the greatest of Stamina and Will (from the greatest of Strength and Intellect).",
    htalent_425_name: "Dark Power",
    htalent_425_description:
      "Damage absorbed with Enhanced Defense increases by <num>30%</num>.<br> Increases damage from class talents and attacks by <num>20%</num>.<br> The first attack during the action of the ultimate ability stuns the target by <num>0.5</num> seconds",
    htalent_426_name: "The power of the tree",
    htalent_426_description:
      "All allied heroes who are nearby have the greatest increase in Strength and Intellect by <num>%s</num> (of Intellect)<br>\r\nThe Oakwood Aid effect increases the hero's stats by <num>5%</num>.<br>\r\n<rz>While the hero is in his native land, the greatest of Strength and Intellect additionally increases by <num>%s</num> (from Intellect).</rz>",
    ...
    htalent_430_description:
      "The Gigantic Strike talent additionally slows down the enemy by <num>20%</num> for <num>2</num> seconds, and additionally deals <fiz>%s</fiz> damage to soldiers and monsters (from Intellect)",
    ...
    htalent_444_description:
      "The hero's attacks additionally deal <fiz>%s</fiz> damage.",
    ...
    htalent_446_description:
      "Talent recovery time of Sulfur Power is reduced by <num>40%</num>.",
    ...
    htalent_449_description:
      "After the expiration of the effect, the enemy hero Buried alive will receive <fiz>%s</fiz> damage.",
    ...
    htalent_451_description:
      "Acid Burst talent hits additional <num>3</num> enemies.",
    ...
    htalent_457_description:
      "With the help of the Brothers-in-Arms talent, the hero summons 2 more helpers.",
    ...
    htalent_459_description:
      "The Stomper Beast deals <num>%s</num> more damage and stuns opponents for <num>0.5</num> sec.",
    ...
    htalent_462_description:
      "The hero moves to the specified point, dealing <mag>%s</mag> damage to all enemies around.",
    ...
    htalent_466_description:
      "The hero swallows the specified enemy hero for <num>3</num> seconds.",
    ...
    htalent_468_description:
      "The hero creates an area around himself that immobilizes enemies in it for <num>4</num> seconds.",
    htalent_469_name: "Circle of Life",
    htalent_469_description:
      "Defender's Oath Talent restores %s to allies in the area<num></num> Health (from Intellect) per second and increases their Stamina and Will by <num>%s</num> (from Intellect).",
    htalent_470_name: "Large-caliber",
    htalent_470_description:
      "The Ruthless Shot Talent deals <num>%s</num> more damage (total <num>%s</num>) and stuns the target for <num>0.5</num> sec. longer.",
    ...
    htalent_473_description:
      "Deals enemies affected by Corpse Poison <mag>%s</mag> (of the highest Strength and Intellect) damage.",
    ...
    htalent_475_description:
      "Reduces the recovery time of <font color=#ff8c00>Bubo</font> to <num>7</num> seconds.\t",
    htalent_476_name: "Fainting",
    htalent_476_description:
      "Talent Heart Attack additionally stuns targets for <num>1.5</num> sec.",
    htalent_477_name: "Panic Attack &#x1F4A7 90 ⌛️12",
    htalent_477_description:
      "Sows panic among the enemies in front of the hero for <num>1.5</num> sec.",
    ...
    htalent_485_description:
      "During the Soul Melody, the cooldown of class talents is reduced by <num>25%</num>",
    ...
    htalent_491_description:
      "The effect of the Mercy Shield talent extends to the hero himself.",
    ...
    htalent_495_description:
      "If a firefight kills an enemy hero, its recovery time is <num>10</num> seconds.",
    htalent_496_name: "Partisan",
    htalent_496_description:
      "Increases the radius of the hero's attacks and the use of the Combat Hello talent.",
    htalent_497_name: "Hawkeye",
    htalent_497_description:
      "The talent of the Guerrilla additionally increases the radius of the hero's vision and the use of talent To guard the borders",
    htalent_498_name: "Concentrated ether",
    htalent_498_description:
      "While the talent is active, the hero's attacks spend <num>3%</num> Energy and additionally inflict <mag>%s</mag> damage and <mag>%s</mag> damage for each accumulated effect of the Lord of Ether.",
    htalent_499_name: "Exhaustion",
    htalent_499_description:
      "While the Concentrated Ether talent is active, the hero's attacks reduce the enemy's Agility by <num>%s</num> (from Intellect) and Speed by <num>30%</num> for <num>3</num> seconds.",
    ...
    htalent_501_description:
      "The talent of the Hunter acts on <num>2</num> targets.",
    ...
    htalent_505_description:
      "If the enemy was not killed by the Tit-for-Tat talent, the hero is reborn after <num>10</num> seconds.",
    ...
    htalent_509_description:
      "Within <num>10</num> seconds, the hero accumulates a charge, which, depending on the degree of readiness, can be used to reapply the Dissec.ting Strike talent, or to shorten its recovery time.",
    ...
    htalent_511_description:
      "The hero becomes invulnerable for <num>2.5</num> seconds, but cannot attack or use any talents.",
    ...
    htalent_514_description:
      "The Lone Blade Path talent deals <num>20%</num> more damage and slows down the target by <num>75%</num>.",
    ...
    htalent_518_description:
      "The Jet Kettlebell talent allows you to fly behind the kettlebell causing <fiz>%s</fiz> damage. ",
    htalent_519_name: "Deafening crash &#x1F4A7 250 ⌛️90",
    htalent_519_description:
      "Rushes at the specified enemy, deals <fiz>%s</fiz> damage and stuns for <num>3</num> seconds.",
    ...
    htalent_526_description:
      "The Ice Wall talent lasts for <num>3</num> seconds longer and stuns enemies for <num>0.5</num> seconds.",
    htalent_527_name: "Super Maneuverability",
    htalent_527_description:
      "When using class talents, the speed increases by <num>50%</num> for <num>3.5</num> seconds.",
    ...
    htalent_530_description:
      "The hero can use the Missile Strike talent for <num>5</num> seconds once more.",
    ...
    htalent_534_description:
      "After using the Maneuvering talent, the hero receives protection for <num>5</num> seconds that absorbs <num>%s</num> (from the greatest of Strength and Intellect).",
    htalent_535_name: "Tsar Bomba",
    htalent_535_description:
      "The Bombardment talent's damage area increases by <num>75%</num>. In the epicenter of the explosion, the damage is <mag>%s</mag>, outside it is <mag>%s</mag>.\n",
    htalent_536_name: "Aimed fire",
    htalent_536_description:
      "Increases the hero's attack radius by <num>15%</num>.<br>\The effect of increasing the attack radius is partially cumulative.",
    ...
    htalent_543_description:
      "The Sweet Dream talent additionally affects enemy heroes near the specified target.",
    ...
    htalent_546_description:
      "The Heaven's Punishment Talent additionally deals <fiz>%s</fiz> damage.",
    ...
    htalent_548_description:
      "The Fire Vortex talent speeds up the hero and slows down enemies by <num>25%</num>.",
    ...
    htalent_550_description:
      "Talent On a chain deals <fiz>%s</fiz> damage when hit.",
    htalent_551_name: "Dogma",
    htalent_551_description:
      "Hero attacks reduce the current cooldown of all class talents by <num>0.5</num> sec.",
    ...
    htalent_554_description:
      "Talent Ritual strike prevents targets from using talents for <num>1.3</num> sec.",
    ...
    htalent_558_description:
      "When using the Tread of Faith talent, the hero applies a Ritual blow to the nearest available target.",
    ...
    htalent_561_description:
      "The Pain Test talent additionally increases the hero's maximum Health by the value taken from the target.",
    ...
    htalent_565_description:
      "The snuffbox cat can withstand <num>8</num> blows, after which it explodes and causes <mag>%s</mag> damage to all enemies around.",
    ...
    htalent_568_description:
      "The hero gets <num>1</num> An arsenal for finishing off enemy creatures and <num>4</num> for the hero.",
    htalent_569_name: "At the forefront of the attack",
    htalent_569_description:
      "Repeated use of talent moves the hero to the edge of a Wave of Blades.",
    ...
    htalent_576_description:
      "The Arsenal effect adds up to <num>8</num> times.",
    ...
    htalent_579_description:
      "Forces the specified target to attack the nearest allied hero or to panic for <num>3</num> seconds.",
    ...
    htalent_582_description:
      "During the effect of One flesh, the effectiveness of decelerations and the duration of other control effects are reduced by <num>40%</num>.",
    ...
    htalent_586_description:
      "The Dangerous Fruit talent blinds offended enemies for <num>0.5</num> seconds for each spore effect on them.",
    ...
    htalent_590_description:
      "The Dream Guardian Talent allows you to attack and use talents.",
    ...
    htalent_593_description:
      "The Dying Vine talent additionally reduces the Speed of touched enemies by <num>80%</num>, decreasing within <num>4</num> seconds.",
    htalent_594_name: "Squall Wind",
    htalent_594_description:
      "The Wind and Sparks talent slows down by <num>10%</num> more, deals <num>25%</num> more damage, and has <num>3</num> effects of Playing with Fire.",
    htalent_595_name: "Healing Trick",
    htalent_595_description:
      "Fox Trick Talent restores hero's <num>%s</num> Health (from the greatest of Strength and Intellect).",
    htalent_596_name: "Buran",
    htalent_596_description:
      "The Blizzard talent additionally deals <mag>%s</mag> damage once every <num>3</num> seconds and lasts <num>1</num> second longer.",
    htalent_597_name: "Chills",
    htalent_597_description:
      "Talent The impregnability of cold additionally reduces the damage inflicted on the hero from attacks and talents by <num>25%</num>.",
    htalent_598_name: "Shower of arrows",
    htalent_598_description:
      "The time to create the Striking Barrage talent is reduced to <num>0.2</num> seconds, and damage is increased by <num>15%</num>. If a talent hits an enemy hero, his cooldown is reduced by <num>3</num> seconds. <br>Total damage <num>%s</num><fiz></fiz> and <mag></mag>. <br><rz>Total damage <num>%s</num><fiz></fiz> and <mag></mag>.</rz>",
    htalent_599_name: "One step ahead",
    htalent_599_description:
      "The talent range of the new position increases by <num>30%</num>, and the amount of damage absorbed by the shield by <num>20%</num>.",
    htalent_600_name: "Impenetrable",
    htalent_600_description:
      "The Stony Talent additionally reduces the damage inflicted on the hero by <num>15%</num>.",
    htalent_601_name: "Deafening Roar",
    htalent_601_description:
      "The Shockwave talent stuns enemies after being thrown for <num>0.4</num> seconds, disarms all affected enemy heroes for <num>1.5</num> seconds, gets the opportunity to pass through creatures for <num>3</num> seconds, inflicts <fiz>%s</fiz> damage (from Maximum health) to enemies below him every <num>0.5</num> seconds while the hero is moving.",
    ...
    htalent_604_description:
      "A fiery blow leaves behind a burning earth, dealing <mag>%s</mag> damage for <num>3</num> seconds.",
    ...
    htalent_607_description:
      "Bloodletting heals two allies and is <num>5% stronger</num>.",
    htalent_608_name: "Special composition",
    htalent_608_description:
      "Unfair Combat Talent deals <num>10%</num> more damage and stuns all affected enemies, and the stun time increases by <num>0.7</num> seconds. Blinding no longer depends on the native land and is always applied.",
    htalent_609_name: "A confident step",
    htalent_609_description:
      "The Flurry of Blows talent also increases the hero's Will by <num>%s</num> (from the greatest of Strength and Intellect).",
    htalent_610_name: "Unstoppable Beast",
    htalent_610_description:
      "Wild Beast talent slows down by <num>20%</num> stronger, deals <mag>%s</mag> more damage and blinds by <num>3</num> sec.",
    htalent_611_name: "Fast adaptation",
    htalent_611_description:
      "Reduces the cooldown of ultimate talents by <num>30</num> seconds.",
    htalent_612_name: "Explosive fruit",
    htalent_612_description:
      "Dangerous fruit bursts when reaching maximum range if it misses the target.",
    htalent_613_name: "Destructive Whisper",
    htalent_613_description:
      "The Forest Spirit talent deals <num>30%</num> more damage. Total <mag>%s</mag>",
    ...
    htalent_615_description:
      "The hero moves in the specified direction, dealing <fiz>%s</fiz> damage to all enemies on the way.",
    ...
    htalent_618_description:
      "Talent Crossbow shot additionally stuns the target for <num>1</num> sec.",
    ...
    htalent_620_description:
      "For <num>3</num> seconds, disarms all enemies around and slows them down by <num>50%</num>.",
    htalent_621_name: "Insubordination",
    htalent_621_description:
      "The Lightning Reflexes talent additionally removes all negative effects.",
    ...
    htalent_625_description:
      "The Undermining talent deals <num>50%</num> more damage and stuns enemies for <num>1</num> sec.",
    htalent_626_name: "Protective disguise",
    htalent_626_description:
      "The Protective Plate talent absorbs more damage by <num>50%</num>. Destroying the protection gives the hero invisibility after <num>1</num> sec. for <num>4</num> sec.",
    htalent_627_name: "Animal Grin",
    htalent_627_description:
      "The chance of the hero and wolves attacking twice increases by <num>15%</num>.",
    htalent_628_name: "Pack Defense",
    htalent_628_description:
      "Pack strength additionally increases the greatest of Stamina and Will by <num>%s</num>.",
    htalent_629_name: "Minor Fret",
    htalent_629_description:
      "Increases the radius of application of non-exclusive class talents by <num>20%</num>.",
    htalent_630_name: "Major mode",
    htalent_630_description:
      "Inspiration effects increased by <num>50%</num>. If an ultimate talent is used with the maximum amount of Inspiration effects, a Native land is formed in the place of its application.",
    htalent_631_name: "Eternal Hunger",
    htalent_631_description:
      "Talent Unquenchable thirst restores by <num>90%</num> More health. <br> Maximum Health increased by <num>30%</num>.",
    htalent_632_name: "Jagged Blade",
    htalent_632_description:
      "The Blood Stroke talent deals <num>90%</num> more damage. Increases talent recovery time by <num>2</num> seconds.",
    ...
    htalent_636_description:
      "The Spear of Retribution talent deals <num>30%</num> more damage and has a <num>25% increased damage area</num>.",
    ...
    htalent_640_description:
      "Talent Overload for <num>6</num> sec. gives the hero protection that absorbs up to <num>%s</num> damage (from the greatest of Strength and Intellect).",
    htalent_641_name: "Splitting",
    htalent_641_description:
      "The Caustic Substance Talent lowers the greatest of Stamina and Will by <num>%s</num> (from the greatest of Strength and Intellect), and slows down enemies by <num>20%</num>.",
    htalent_642_name: "Protective Circle",
    htalent_642_description:
      "While in the Alchemy Circle, the hero increases his Will by <num>%s</num> (from the greatest of Strength and Intellect) and replenishes <num>2%</num> of missing Health and Energy per second.<br>\r\Circle creates a zone of visibility, detecting invisibles.",
    htalent_643_name: "The last frontier",
    htalent_643_description:
      "The Machine gun talent does not stop and deals <num>15%</num> more damage (+<fiz>%s</fiz> and +<mag>%s</mag>). The hero takes <num>30%</num> less damage while the talent is active.",
    htalent_644_name: "Upgrade",
    htalent_644_description:
      "A self-propelled gun uses <num>25</num><detail></detail> less talent and attacks <num>25%</num> faster.",
    ...
    htalent_646_description:
      "The recovery time of the Color of Life talent is reduced by <num>5</num> seconds.",
    ...
    htalent_649_description:
      "The magic damage inflicted on enemies around is additionally increased by <num>7%</num>.<br>\The effect of the Lord of Ether talent on the hero is added an additional <num>7</num> times.",
    htalent_650_name: "Ethereal Bastion",
    htalent_650_description:
      "The Ethereal Shield Talent absorbs <num>20%</num> more damage.<br>\The hero's maximum Energy increases by <num>22%</num>.",
    ...
    htalent_652_description:
      "The area of damage to talent Crossbow shot becomes wider by <num>25%</num>.",
    ...
    htalent_656_description:
      "The Explosive approach talent causes soldiers to <num>50%</num>, and monsters <num>30%</num> more damage.",
    ...
    htalent_660_description:
      "An enemy hero caught in the net of the talent Intellect to stop loses <num>%s</num> of the greatest of Stamina and Will (from the greatest of Strength and Intellect) for <num>5</num> seconds.",
    htalent_661_name: "Mass mailing!",
    htalent_661_description:
      "Talent Threat from the air causes damage in the area.",
    htalent_662_name: "Third test!",
    htalent_662_description:
      "Increases magazine capacity by <num>1</num> cartridge.<br>The hero's attacks deal <num>7%</num> more damage.",
    htalent_663_name: "It won't seem enough!",
    htalent_663_description:
      "The Third control talent increases the magazine capacity by another <num>1</num> cartridge.<br>The hero's attacks deal <num>7%</num> more damage.",
    htalent_664_name: "Stray bullet!",
    htalent_664_description:
      "The hero's attack additionally hits the enemy closest to the target.",
    ...
    htalent_667_description:
      "The Ferocious Hurricane talent increases hero speed by <num>30%</num> and Health Theft by <num>%s</num> (from Strength).",
    htalent_668_name: "Tenacious Strike",
    htalent_668_description:
      "Gigantic Strike Talent deals <num>20%</num> (<fiz>%s</fiz>) more damage and immobilizes the target for <num>0.5</num> sec.",
    htalent_669_name: "Thorn Bonds",
    htalent_669_description:
      "The Dense Thorns talent immobilizes enemies for <num>1</num> sec. and additionally deals <mag>%s</mag> damage.",
    htalent_670_name: "Iron Leg",
    htalent_670_description:
      "A flying kick talent always does double damage (<fiz>%s</fiz>), and the cooldown is reduced by <num>4</num> seconds, regardless of the Native land.",
    htalent_671_name: "Invulnerable",
    htalent_671_description:
      "<num>+%s</num> Durability (from Strength)<br>The Unstoppable talent additionally restores <num>2%</num> of missing Health.",
    htalent_672_name: "Eat for two!",
    htalent_672_description:
      "The Glutton Talent additionally increases maximum Health by <num>%s</num> for each accumulated effect (maximum in total <num>%s</num> Health).",
    htalent_673_name: "You won't leave now!",
    htalent_673_description:
      "Grab your talent! attracts the first enemy hero, ignoring the creatures.",
    htalent_674_name: "Iron Assault",
    htalent_674_description:
      "The talent of a front-line comrade additionally increases the Speed of the bear from the speed of the hero himself (the effect is partially formed) and Stamina and Will by <num>%s</num> (from the greatest of Strength and Intellect).",
    htalent_675_name: "Steel grip",
    htalent_675_description:
      "Border Guard Talent increases trap size by <num>30%</num> and additionally reduces Stamina (from Strength) or Will (from Intellect) by <num>%s</num>, depending on the hero's highest parameter.",
    ...
    htalent_678_description:
      "Every third attack of the hero stuns the enemy for <num>0.2</num> sec.",
    htalent_679_name: "The decisive moment",
    htalent_679_description:
      "The Merciless Time talent additionally causes <mag>%s</mag> when exploding.",
    htalent_680_name: "Aegis of Time ⌛️10",
    htalent_680_description:
      "When a hero is stunned, he absorbs <num>15%</num> incoming damage for <num>3</num> seconds.",
    ...
    htalent_683_description:
      "The Time has Passed Talent returns the target's Health and Energy to their values at the time of talent application: increases for the hero and decreases for the enemy.",
    htalent_684_name: "Short interval",
    htalent_684_description:
      "Temporary Anomaly Talent slows down enemies in an area by <num>30%</num>.",
    htalent_685_name: "Instant Reaction",
    htalent_685_description:
      "Activating the Aegis of Time talent stuns enemies around for <num>0.5</num> sec.",
    htalent_686_name: "Time has stopped",
    htalent_686_description:
      "The Time has Passed talent stuns the enemy for <num>0.5</num> seconds after moving. The radius of talent application has been increased.",
    htalent_687_name: "Sprawl",
    htalent_687_description:
      "The area of damage to the Roots of Evil talent increases by <num>50%</num>, and the decrease in target's health recovery does not depend on the native land.",
    ...
    htalent_690_description:
      "<num>+%s</num> to the greatest of Stamina and Will (from Strength) during Prime Time Talent.",
    htalent_691_name: "Ghost Armor",
    htalent_691_description:
      "The lifespan of ghosts increases by <num>100%</num>, and their Stamina and Will by <num>%s</num> (from the greatest of Strength and Intellect).",
    htalent_692_name: "Afterlife protection",
    htalent_692_description:
      "The Ghost Shield talent absorbs <num>25%</num> more damage, and each blow to it, with an interval of <num>0.3</num> seconds, restores the specified allied hero <num>%s</num> Health (from the Intellect).",
    htalent_693_name: "Deep wounds",
    htalent_693_description:
      "Talent Bleeding causes <num>30%</num> more damage.",
    htalent_694_name: "Explosive Arrow",
    htalent_694_description:
      "The Enchanted Arrow Talent deals <num>1.3</num> times more damage to the enemy under the bleeding effect.",
    htalent_695_name: "Medicinal pollen",
    htalent_695_description:
      "Guardian Fairy Talent increases Allied Health Regeneration by <num>%s</num> (from Intellect) for <num>10</num> sec.",
    htalent_696_name: "Fairy Rampage",
    htalent_696_description:
      "The Fury of Fairies talent reduces the Speed of enemies by <num>25%</num> for <num>4</num> seconds and deals <num>25%</num> more damage (Warrior Fairies <fiz>+%s</fiz> damage. Guardian Fairies <mag>+%s</mag> damage).",
    htalent_697_name: "Shield of Purity",
    htalent_697_description:
      "<rz>The Purity Shield talent deals <num>2</num> times more damage on its native land.</rz>",
    htalent_698_name: "Healing Balance",
    htalent_698_description:
      "Talent restores the balance of power by <num>100%</num> More health (<num>+%s</num>).",
    htalent_699_name: "Stunning Fan",
    htalent_699_description:
      "The Magic Fan talent, after being pushed away, stuns the target for <num>0.5</num> seconds. The effect does not apply to the ultimate talent of Fan Dance.",
    htalent_700_name: "Shadow for two",
    htalent_700_description:
      "The Shadow Protection talent does not remove the hero from invisibility, but when applied to an allied hero, it extends to the Shadow itself. Bonuses and stats are valid for <num>2</num> seconds longer after emerging from the cover.",
    htalent_701_name: "Poison Throw",
    htalent_701_description:
      "The Lethal Throw Talent poisons <num>3</num> times with Snake Venom. Snake Venom Talent deals <num>50% more damage</num>.",
    htalent_702_name: "Snake extract",
    htalent_702_description:
      "The Snake Flexibility Talent reduces talent damage by <num>20%</num>.",
    htalent_703_name: "The Fortress of Ice",
    htalent_703_description:
      "The Ice Spawn talent increases damage absorption to <num>15%</num> for each effect and duration up to <num>3</num> seconds.",
    htalent_704_name: "Ice Destruction",
    htalent_704_description:
      "The Frost Onslaught talent stuns for <num>0.2</num> seconds more and deals <num>35%</num> more damage.",
    ...
    htalent_707_description:
      "Familiar attack targets panic for <num>0.5</num> sec.",
    htalent_708_name: "Witch Cover",
    htalent_708_description:
      "During the recovery of the Magic Boost talent, the greatest of Stamina and Will increases by <num>%s</num> (from the greatest of Strength and Intellect).",
    htalent_709_name: "The Greed of the Murderer",
    htalent_709_description:
      "Upon killing or supporting, the hero additionally receives <prime>200</prime>. ",
    htalent_710_name: "The brutality of the murderer",
    htalent_710_description:
      "When killing or supporting, the victim's resurrection time is additionally increased by <num>20%</num>.",
    ...
    htalent_713_description:
      "Honey additionally slows down opponents by <num>10%</num> and deals them <fiz>%s</fiz> damage per second.",
    htalent_714_name: "Oak Barrel &#x1F4A7 250 ⌛️60",
    htalent_714_description:
      "The hero pours Honey on all the heroes around and causes <fiz>%s</fiz> damage to all enemies.",
    ...
    htalent_716_description:
      "Attacks with a <num>21% chance</num> spill Honey on the target.",
    htalent_717_name: "The skill of the Honey Cooker",
    htalent_717_description:
      "The Honey Pot Talent has an extended range.<br>\n<rz>When used, Honey is poured from the native land.</rz>",
    htalent_718_name: "Invigorating mead",
    htalent_718_description:
      "Attacks reduce talent recovery time by Taking Honey and Hot Honey by <num>0.1</num> seconds for each Honey effect on the hero and target of the attack.",
    htalent_719_name: "Mature Honey",
    htalent_719_description:
      "The Honey effect adds up to <num>1</num> times more.<br>\n<rz>If there are <num>4 </num> effects of Honey, the enemy in his native land is disarmed.</rz>",
    htalent_720_name: "Protection of the honey cooker",
    htalent_720_description:
      "Honey additionally increases the least of the Stamina and Will of allies by <num>%s</num> (from Intellect).",
    ...
    htalent_722_description:
      "The hero's attacks and Dissec.ting Strike Talent set the enemy on fire, dealing <mag>%s</mag> damage (from the highest of Strength and Intellect) for <num>3</num> seconds.<br>The effect adds up to <num>3</num> times.",
    htalent_723_name: "Deadly Blade",
    htalent_723_description:
      "Increases the damage of ultimate talents by <num>25%</num>.<br>Lone Blade Path <fiz>+%s</fiz><br> Thousand Blades Path <mag>+%s</mag>",
    htalent_724_name: "Humility",
    htalent_724_description:
      "The Ritual Strike talent slows down enemies by <num>50%</num> and is no longer distributed, but deals full damage to all enemies.",
    htalent_725_name: "Of One Faith",
    htalent_725_description:
      "If the target of the Oath talent is an ally, the effect is additionally applied to the hero. <br> The Pain Test takes away <num>%s</num> more Health (from Strength). <br> The Talent of the Righteous Man's Reward increases the hero's Health twice as much.",
    htalent_726_name: "Deterrent Strike",
    htalent_726_description:
      "The Leader's Strike talent also slows down enemies by <num>30%</num>.",
    htalent_727_name: "Shoulder to Shoulder",
    htalent_727_description:
      "The Enchanted Armor Talent effect additionally reduces damage inflicted on allies.",
    htalent_728_name: "Honey bitterness",
    htalent_728_description:
      "Honey additionally reduces the Resistance of opponents by <num>%s</num> (of Strength). The effect of Honey adds up to <num>1</num> times more.",
    htalent_729_name: "The generosity of the honey cooker",
    htalent_729_description:
      "When using the Honey Pot talent, the hero additionally pours Honey when encountering allied heroes. Pours Honey on enemies twice.",
    htalent_730_name: "Combat readiness",
    htalent_730_description:
      "Each use of the Blade Wave talent gives <num>1</num> Arsenal.",
    htalent_731_name: "Iron discipline",
    htalent_731_description:
      "Area of talent damage Order of Battle and Eternal Service increases by <num>30%</num>.<br>\r\nThe combat order lasts for <num>2</num> seconds longer.",
    htalent_732_name: "Deep breath",
    htalent_732_description:
      "By applying a second Wind talent, the hero returns <num>50%</num> of the Heroism used.",
    htalent_733_name: "Liberator",
    htalent_733_description:
      "The Bodyguard talent additionally removes the most dangerous of the negative effects from the target.",
    htalent_734_name: "The Mighty Lord",
    htalent_734_description:
      "Increases the maximum number of archons in the hero's service by <num>1</num>.",
    ...
    htalent_736_description:
      "The Desperate Dash talent also stuns enemies for <num>0.5</num> seconds and increases the greatest of Agility and Cunning by <num>%s</num> (from the greatest of Strength and Intellect) for <num>8</num> seconds.",
    htalent_737_name: "The Light of Unity",
    htalent_737_description:
      "The Healing Light talent increases the greatest of the Stamina and Will of allied heroes by <num>%s</num> (from the greatest of Strength and Intellect).",
    htalent_738_name: "The Wrath of Chaos",
    htalent_738_description:
      "The Blades of Chaos talent increases the damage inflicted by class talents and hero attacks by <num>5%</num> when changing stance.",
    htalent_739_name: "Face of Chaos",
    htalent_739_description:
      "The Blades of Chaos talent increases the hero's chance of evading by <num>5%</num> when changing stance.",
    ...
    htalent_743_description:
      "The cost of the Destructive Strikes talent increases to <num>15%</num> of the current Health.<br>Each effect of the Destructive Strikes talent increases the additional damage from the hero's attacks by <num>%s</num>.",
    htalent_744_name: "Dark Matter",
    htalent_744_description:
      "The Energy Cluster talent deals more damage by <num>%s</num> and recovers by <num>2</num> seconds faster.",
    ...
    htalent_748_description:
      "If the Healing talent affects heroes whose Health is below <num>50%</num>, it replenishes <num>%s</num> with more Health.",
    htalent_749_name: "Aegis of Earth",
    htalent_749_description:
      "The Earth Blessing talent additionally creates a defense that blocks <num>1</num> control effect.",
    ...
    htalent_752_description:
      "Hero's speed increases by <num>7%</num> for every 1F47F.",
    ...
    htalent_762_description:
      "A spear flies through enemy heroes. And additionally increases spear damage by <num>20%</num>.",
    htalent_763_name: "Premonition of death",
    htalent_763_description:
      "By dealing critical damage, the hero instantly reduces the attack recovery time.",
    htalent_764_name: "Without prying eyes",
    htalent_764_description:
      "Reduces the cooldown of the Blade of Darkness by <num>30%</num> if the hero kills an enemy.",
    htalent_765_name: "Fire Mark",
    htalent_765_description:
      "An enemy struck by a Fire Curse cannot escape. <br> The hero's attack range on targets with the Fire Curse effect has been increased by <num>5</num>.",
    htalent_766_name: "Embrace by Flame",
    htalent_766_description:
      "During the application of ultimate talents, the hero receives <num>35%</num> talent protection.",
    ...
    htalent_771_description:
      "The bone trap becomes invisible and deals <fiz>%s</fiz> damage to the enemy hero trapped in it.",
    ...
    htalent_775_description:
      "If the target of the Monstrous Hunger talent dies, all opponents around will panic for <num>2</num> seconds.",
    ...
    htalent_777_description:
      "Killing or supporting the killing of an enemy hero prolongs the effect of the Nightmare Time talent for <num>5</num> seconds.",
    htalent_778_name: "Bone Crunching",
    htalent_778_description:
      "After the hero is moved, the Bone Trap explodes, dealing <mag>%s</mag> damage (from the greatest of Strength and Intellect) to all enemies around.",
    htalent_779_name: "Obsession",
    htalent_779_description:
      "Heroes without the Curse of Hunger effect additionally receive <fiz>%s</fiz> damage from hero attacks.",
    htalent_780_name: "Prestige",
    htalent_780_description:
      "When applying a class talent, the hero becomes invulnerable to damage for <num>0.5</num> sec.",
    htalent_781_name: "Wildfire &#x1F4A7 90 ⌛️8",
    htalent_781_description:
      "After <num>0.6</num> seconds, it deals <fiz>%s</fiz> damage to enemies in the specified area.",
    ...
    htalent_790_description:
      "Upon reaching the target, the wave returns back to the hero, dealing <mag>%s</mag> damage to all enemies on the way back and stunning for <num>2</num> seconds those who were hit by the wave twice.<br>\r\nThe repeated activation of talent causes the wave to return to the hero ahead of schedule after <num>0.5</num> seconds.",
    ...
    htalent_794_description:
      "In the indicated direction, for <num>6</num> seconds, an area appears that drains enemies every <num>1.5</num> seconds.",
    htalent_795_name: "Soporific whisper <mana>140</mana> <CD>18</CD>",
    htalent_795_description:
      "<num>2</num> seconds are created, during which the specified enemy cannot attack, use abilities, or move. The effect stops prematurely when the target is hit with more than <num>20%</num> of its maximum Health.",
    htalent_796_name: "Healing Shroud",
    htalent_796_description:
      "Inside the area created by the Shroud of Shadows talent, and for <num>5</num> seconds after exiting, the speed of allied heroes increases by <num>25%</num>, and Health regeneration by <num>%s</num> (from Cunning).",
    htalent_797_name: "Terrifying scream",
    htalent_797_description:
      "When the creation of the Soporific Whisper talent is interrupted or completed, the target and all enemies around it receive <mag>%s</mag> damage <rz> and cannot use talents for <num>1</num> sec. in the hero's native land.</rz>",
    htalent_798_name: "Foggy Step <mana>80</mana> <CD>18</CD>",
    htalent_798_description:
      "The hero is moving in the specified direction.<br>\r\When the talent is ready to be used, the hero's agility is increased by <num>%s</num> (from Intellect).",
    htalent_799_name: "Fatal Withering <mana>240</mana> <CD>90</CD>",
    htalent_799_description:
      "Health Regeneration the specified enemy hero's time <num>2.5</num> seconds is reduced by <num>%s</num> (from Intellect) or <num>%s</num> (from Cunning), (the largest is selected).",
    htalent_800_name: "Extinguished candle <CD>18</CD>",
    htalent_800_description:
      "All class talents except the ultimate are instantly restored upon the death of a desiccated enemy hero.",
    ...
    htalent_802_description:
      "Causes <mag>%s</mag> damage to all enemies around.",
    htalent_803_name: "Saturation with life",
    htalent_803_description:
      "The Twilight Surge talent, after <num>0.5</num> seconds after application, additionally restores Health to all allied heroes around by <num>%s</num> (from Intellect) or <num>%s</num> (from Cunning), (the highest is selected) for every enemy hero who gets hurt.",
    htalent_804_name: "Old matter",
    htalent_804_description:
      "The desiccation effect additionally reduces the opponents' Will by <num>%s</num> (from Intellect) or <num>%s</num> (from Cunning), (the largest is selected).",
    htalent_805_name: "Disembodied form",
    htalent_805_description:
      "The Fog Step Talent for <num>6</num> seconds reduces hero damage by <num>5%</num> for each withered enemy and additionally increases hero Evasion by <num>20%</num> when ready to use.",
    ...
    htalent_808_description:
      "The hero is transported to the specified location.",
    htalent_809_name: "Afterlife cold",
    htalent_809_description:
      "Soul Totem Talent reduces enemies' Speed by <num>18%</num> for 2.5 sec.",
    htalent_810_name: "Ancestral Power",
    htalent_810_description:
      "After applying the Vanishing talent, the hero performs double attacks for <num>5</num> seconds.",
    htalent_811_name: "Treacherous Ivy <mana>100</mana> <CD>30</CD>",
    htalent_811_description:
      "He plants a seed in the specified place, from which invulnerable ivy grows after <num>2</num> seconds. The enemy who steps on him reveals his position for <num>5</num> seconds.<br>\r\n Stepping on the ivy, the enemy loses <num>10%</num> of Strength and Intellect.\r\n<br>\r\n Supports no more than <num>5</num> ivies at a time.",
    htalent_812_name: "Primal Rage <mana>200</mana> <CD>90</CD>",
    htalent_812_description:
      "For <num>2.2</num> seconds, the hero becomes immune to control effects and makes three jumps, dealing all enemies around <fiz>%s</fiz> damage from the greatest of Strength and Intellect.",
    htalent_813_name: "Ancestral Protection",
    htalent_813_description:
      "Using the Disappearing talent gives the hero protection for <num>4</num> seconds, absorbing up to <num>%s</num> damage (from the greatest of Strength and Intellect).",
    htalent_814_name: "The cracking of bones",
    htalent_814_description:
      "The Primal Rage talent additionally stuns enemies for <num>0.3</num> sec.",
    htalent_815_name: "Creepy call <mana>200</mana> <CD>90</CD>",
    htalent_815_description:
      "Creates <num>0.4</num> sec. and forces the enemy hero to walk towards the source of the call for <num>2,5</num> sec. The enemy hero cannot use talents at the same time. The enemy's attack range is reduced to <num>0</num>.",
    htalent_816_name: "Devastation",
    htalent_816_description:
      "During the Eerie Call talent, the Stamina and Will of the enemy hero are reduced by <num>%s</num> (from Intellect).",
    htalent_817_name: "The Rage of the Ancestors",
    htalent_817_description:
      "The first attack after using the Vanishing talent stuns the enemy by <num>1</num>.",
    htalent_818_name: "Arcane Magic",
    htalent_818_description:
      "The allies around you take <num>10% less physical damage</num>.",
    htalent_819_name: "Firecrackers",
    htalent_819_description:
      "Hero attacks additionally deal <num>30%</num> damage to enemies around the target.",
    ...
    htalent_821_name:
      "Sniffer Rocket <mana>150</mana> <CD></CD><mag>30</mag>/<CD></CD><fiz>15</fiz>",
    ...
    htalent_823_description:
      "The Sniffer Missile talent additionally slows down the target.<br> If the hero's Intellect is greater than his strength, then the deceleration time is <num>2</num> seconds, the deceleration force is <num>20%</num>.<br> If the hero's strength is greater than his Intellect, then the deceleration time <num>is 4</num> seconds, the deceleration force <num>is 40%</num>.",
    ...
    htalent_827_description:
      "Increases the duration of the ultimate talent by <num>2</num> sec.",
    htalent_828_name: "Cluster mines <mana>240</mana> <CD>70</CD>",
    htalent_828_description:
      "Mines all enemy heroes in the specified area for <num>2</num> seconds.<br>Upon completion of mining or upon death of the target, she and all enemies around receive <fiz>%s</fiz> damage (from the greatest of Strength and Intellect).",
    htalent_829_name: "Heavy charge",
    htalent_829_description:
      "The speed of enemies who mine Cluster mines is reduced by <num>50%</num>, and their explosion additionally stuns for <num>1</num> sec.",
    ...
    talent_10_description:
      "When an enemy soldier or monster dies nearby, the hero restores <num>%s</num> Health.",
    ...
    talent_15_description:
      "The hero's attacks additionally inflict <fiz>%s</fiz> damage on soldiers and chudis.<br>Finishing them off, the hero gets <prime>5</prime>. After receiving <prime>675</prime> the influx stops from this talent.<br>",
    talent_16_name: "Natural Restoration",
    talent_16_description:
      "Increases the Health regeneration of the hero and nearby allies by <num>%s</num>",
    ...
    talent_23_description:
      "Increases the hero's Stamina and Will by a total of <num>%s</num>.<br/>Each hit on the hero redistributes the boost, increasing by <num>25%</num> the characteristic that protects against the type of damage received.",
    ...
    talent_28_description:
      "Upon resurrection, the hero receives <prime>50</prime>  and increases your maximum health by <num>%s</num>. The maximum total Health gain is <num>%s</num>.",
    talent_29_name: "Stealing the Intellect",
    talent_29_description:
      "The attack burns <num>1% of the enemy's current Energy and deals twice as much damage from the burned energy. (The effect works if the attacker has a stat. Energy).",
    ...
    talent_37_description:
      "<num>The attacker</num><br><br>When activated, it inflicts <mag>%s</mag> on the specified enemy.",
    ...
    talent_39_description:
      "The stamina and Will of all enemies around is reduced by <num>%s</num>.",
    talent_40_name: "Team spirit",
    talent_40_description:
      "All allies around receive <num>%s</num> Powers and <num>%s</num> Will.",
    ...
    talent_44_description:
      "Every <num>6</num> seconds restores %s to all allies around <num></num> Health.",
    ...
    talent_59_description:
      "A hero receives <num>0.06</num> Strength for each creature he kills, or <num>1</num> Strength for each hero he kills. The maximum total increase is <num>%s</num>.",
    talent_60_name: "Intellect training",
    talent_60_description:
      "A hero receives <num>0.06</num> Intellect for each creature he kills, or <num>1</num> Intellect for each hero he kills. The maximum total increase is <num>%s</num>.",
    talent_61_name: "Survival of the Fittest",
    talent_61_description:
      "The hero gets <num>1</num> Health for each soldier he kills or <num>10</num> Health for every hero he kills. The maximum total increase is <num>%s</num>.",
    ...
    talent_65_description:
      "The hero's maximum Energy increases by <num>3</num> when Energy-consuming talents are activated. The maximum total increase is <num>%s</num>.",
    talent_66_name: "Steel hardening",
    talent_66_description:
      "The hero's maximum Durability increases by <num>0.2</num> when taking <num>200</num> damage. The maximum total increase is <num>%s</num>.",
    ...
    talent_68_description:
      "<num>Protective</num><br><br>When activated, the hero becomes immune to magic damage for 2 seconds.",
    ...
    talent_82_description:
      "The hero's base speed increases by <num>%s</num>. Of the passive effects of increasing speed, the maximum one acts.",
    ...
    talent_91_description:
      "A hero's attack with a <num>25%</num> chance additionally deals <Mag>%s</Mag> damage to the enemy and reduces its Speed by <num>20%</num> by <num>2</num> seconds.",
    ...
    talent_101_description:
      "Restores <num>%s</num> Health points for killing a soldier or a chud.",
    ...
    talent_108_description:
      "Energy regeneration of all allies around increases by <num>%s</num>.",
    ...
    talent_115_description:
      "The Intellect of all allies around increases by <num>%s</num>, and Stamina increases by <num>%s</num>.",
    ...
    talent_118_description:
      "The hero gets <num>0.06</num> Agility for each creature he kills or <num>1</num> Agility for every hero he kills. The maximum total increase is <num>%s</num>.",
    talent_119_name: "Increasing cunning",
    talent_119_description:
      "The hero gets <num>0.06</num> Cunnings for each creature he kills or <num>1</num> Cunnings for every hero he kills. The maximum total increase is <num>%s</num>.",
    ...
    talent_128_description:
      "During an auto attack with a <num>45%</num> chance, reduces the target's Durability by <num>%s</num> for <num>4</num> seconds.",
    talent_129_name: "Suppression of the will",
    talent_129_description:
      "In an auto-attack with a 45%chance reduces the target's Will by <num>%s</num> for 4 seconds.",
    ...
    talent_135_description:
      "The strength and Intellect of all allies around increases by <num>%s</num>",
    talent_136_name: "Radiating danger",
    talent_136_description:
      "The durability of all enemies around is reduced by <num>%s</num>.",
    talent_137_name: "Dangerous enemy",
    talent_137_description:
      "The will of all enemies around is reduced by <num>%s</num>.",
    ...
    talent_142_description:
      "A hero receives <num>0.04</num> Strength for each creature he kills, or <num>1</num> Strength for each hero he kills. The maximum total increase is <num>%s</num>. ",
    talent_143_name: "The Hidden Intellect",
    talent_143_description:
      "A hero receives <num>0.04</num> Intellect for each creature he kills, or <num>1</num> Intellect for each hero he kills. The maximum total increase is <num>%s</num>.",
    ...
    talent_167_description:
      "For every <num>20%</num> of missing Health, the hero receives <num>1</num> Strength.",
    talent_168_name: "A desperate Intellect",
    talent_168_description:
      "For every <num>20%</num> of missing Health, the hero receives <num>1</num> of Intellect.",
    ...
    talent_181_description:
      "<num>Protective</num><br><br>When activated, enemy-imposed effects are removed from all around.",
    ...
    talent_210_description:
      "The hero receives <num>0.3</num> Health Theft for each soldier he kills and <num>3</num> Health theft for each hero he kills. The maximum total increase is <num>%s</num>",
    ...
    talent_227_description:
      "With a <num>35%</num> chance, the hero ignores <num>%s</num> of enemy attack damage.",
    ...
    talent_231_description:
      "The hero's Base Speed increases by <num>6</num>, and if he does not receive or deal damage for <num>5</num> seconds, the base Speed increases by <num>%s</num>. Of the passive effects of increasing Speed, the maximum is effective.",
    ...
    talent_253_description:
      "The hero's attacks additionally inflict <fiz>%s</fiz> damage on soldiers and chudis.<br>Finishing them off, the hero gets <prime>5</prime>. After receiving <prime>675</prime> the influx stops from this talent.<br>Only one of the talents of excellence is active.",
    ...
    talent_268_description:
      "Restores <num>%s</num> Health when killing an enemy hero or supporting.",
    ...
    talent_271_description:
      "Killing an enemy hero reduces the cooldown of all abilities by <num>12%</num>",
    ...
    talent_282_description:
      "<num>+%s</num> Speeds are always<br><br>The speed of the allied hero with the lowest <num>%</num> Health below <num>50%</num> increases by <num>15%</num>.",
    ...
    talent_291_description:
      '<font color=#A5A5A5>Set</font> <font color=#ff8c00>"Reflection of the entity"</font>',
    ...
    talent_296_description:
      '<font color=#A5A5A5>Set</font> <font color=#ff8c00>"Night Hunter"</font>',
    ...
    talent_339_name:
      "A cluster of misfortunes<font color=#FFFFFF> ⌛️115</font>",
    ...
    talent_341_name:
      "The Path of the Punisher<font color=#FFFFFF> ⌛️120</font>",
    ...
    talent_366_description:
      "<num>+%s</num> <rz>Stamina in the native land</rz>",
    talent_367_name: "Strong-willed face",
    talent_367_description:
      "<num>+%s</num> <rz>Freedom in the native land</rz>",
    talent_368_name: "Vigilance",
    talent_368_description: "<rz>-%s%⌛ in his native land</rz>",
    talent_369_name: "The Gift of Cunning",
    talent_369_description:
      "<num>+%s</num> <rz>Cunnings on the native land</rz>",
    talent_370_name: "The Indomitability of the beast",
    talent_370_description:
      "<num>+%s</num> <rz>Agility in the native land</rz>",
    talent_371_name: "Intuition of the beast",
    talent_371_description:
      "<num>+%s</num> <rz>Agility in his native land</rz>",
    ...
    talent_374_description:
      "<num>+%s</num> <rz>The Intellect of the native land</rz>",
    ...
    talent_378_description:
      " <num>+%s</num> <rz>Forces in the native land</rz>",
    talent_379_name: "Elegant Intellect",
    talent_379_description:
      " <num>+%s</num> <rz>The Intellect of the native land</rz>",
    talent_380_name: "Insatiability",
    talent_380_description:
      " <num>+%s</num> <rz>Stealing health in their native land</rz>",
    talent_381_name: "The original Cunning",
    talent_381_description:
      " <num>+%s</num> <rz>Cunnings in the native land</rz>",
    ...
    talent_384_description:
      "  <num>+%s</num> <rz>Theft of health in the native land</rz>",
    ...
    talent_389_description:
      " <num>+%s</num> <font color=#F08080>Regenerating health on enemy or neutral ground</font>",
    ...
    talent_391_description:
      " <num>+%s</num> <font color=#F08080>Cunnings on enemy or neutral ground</font>",
    talent_392_name: "The lightness of a butterfly",
    talent_392_description:
      " <num>+%s</num> <font color=#F08080>Agility on enemy or neutral ground</font>",
    talent_393_name: "Rationality",
    talent_393_description:
      " <num>+%s</num> <font color=#F08080>Energy regeneration on enemy or neutral ground</font>",
    talent_394_name: "Practicality",
    talent_394_description:
      " <num>+%s</num> <font color=#F08080>Energy regeneration on enemy or neutral ground</font>",
    talent_395_name: "Destructive Strength",
    talent_395_description:
      " <num>+%s</num> <font color=#F08080>Forces on enemy or neutral ground</font>",
    talent_396_name: "Stubbornness",
    talent_396_description:
      " <num>+%s</num> <font color=#F08080>Regenerating health on enemy or neutral ground</font>",
    talent_397_name: "The Creative Intellect",
    talent_397_description:
      " <num>+%s</num> <font color=#F08080>Intellect on enemy or neutral ground</font>",
    ...
    talent_400_description:
      "<num>+%s</num> <font color=#F08080>to the greatest of Stamina and will on enemy or neutral ground</font>",
    talent_401_name: "Intellectable precaution",
    talent_401_description:
      "<num>+%s</num> <font color=#F08080>to the greatest of Stamina and will on enemy or neutral ground</font>",
    talent_402_name: "Obsession with blood",
    talent_402_description:
      "<num>+%s</num> <font color=#F08080>Health steals on enemy or neutral ground</font>",
    ...
    talent_404_description:
      "Every minute, Health increases by an additional <num>12</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(12 minutes)</col1>",
    talent_405_name: "Bloody delight",
    talent_405_description:
      "For each creature killed, the theft of Health increases by <num>0.04</num>, and for killing a hero - by <num>0.4</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(125 creeps/13 heroes).</col1>",
    talent_406_name: "Growing Strength",
    talent_406_description:
      "Every minute The Strength increases by an additional <num>0.4</num>. The total bonus cannot be greater than <num>%s</num>.<br>\n<col1>(400 sec.).</col1>",
    talent_407_name: "Enlightenment",
    talent_407_description:
      "Every minute, the Intellect increases by an additional <num>0.4</num>. The total bonus cannot be greater than <num>%s</num>.<br>\n<col1>(400 sec.)</col1>",
    talent_408_name: "Inflexibility",
    talent_408_description:
      "After each Resurrection, Health increases by an additional <num>36</num>.<br>\r\nThe sum bonus cannot be greater than <num>%s</num>.<br>\r\n<col1 > (5 times).</col1><br>\r\nWith each visit to the resurrection site, the hero's speed increases by <num> 70%</num > until he takes or deals damage.",
    talent_409_name: "Hard Logic",
    talent_409_description:
      "For every <num>100</num> damage taken, the Intellect increases by an additional <num>0.04</num>. <br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(12000 damage)</col1>",
    talent_410_name: "Harsh Strength",
    talent_410_description:
      "For every <num>100</num> damage taken, the strength increases by an additional <num>0.04</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(12000 damage)</col1>",
    talent_411_name: "Recovery",
    talent_411_description:
      "For each creature killed, Health Regeneration increases by <num>0.02</num>, and for killing a hero — by <num>0.2</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(130 creeps/13 heroes)</col1>",
    talent_412_name: "Killer Logic",
    talent_412_description:
      "For each Creature Killed, The Intellect increases by an additional <num> 0.36</num>, and for the murder of the hero — by <num>3.6</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(50 creeps/5 Heroes)</col1>",
    talent_413_name: "Murderous Rage",
    talent_413_description:
      "For each creature killed, the Strength increases by <num>0.36</num>, and for killing a hero — by <num>3.6</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(50 creeps/5 Heroes)</col1>",
    talent_414_name: "Liberated Intellect",
    talent_414_description:
      "For each Creature Killed, The Intellect increases by an additional <num> 0.06</num>, and for the murder of the hero — by <num>0.6</num>.<br>The total bonus cannot be more than <num>%s</num>.<br><col1>(150 creeps/15 Heroes)</col1>",
    talent_415_name: "Unstoppable Strength",
    talent_415_description:
      "For each application next to the hero of an active talent, the strength increases by <num>0.18</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(100 activations)</col1>",
    talent_416_name: "Unstoppable Intellect",
    talent_416_description:
      "For each application of active talent next to the hero, The Intellect increases by <num>0.18</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(100 activations)</col1>",
    talent_417_name: "Increasing Audacity",
    talent_417_description:
      "Every minute, the Cunning increases by an additional <num>0.6</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(15 minutes)</col1>",
    talent_418_name: "Rising Frenzy",
    talent_418_description:
      "Every minute agility increases by <num>0.6</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(15 minutes)</col1>",
    talent_419_name: "Deadly Knowledge",
    talent_419_description:
      "For each killed creature, agility increases by an additional <num>0.05</num>, and for killing a hero — by <num>0.5</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br><col1>(140 creeps/14 heroes)</col1>",
    talent_420_name: "Deadly Strength",
    talent_420_description:
      "For each killed creature, agility increases by an additional <num>0.05</num>, and for killing a hero — by <num>0.5</num>.<br>The total bonus cannot be more than <num>%s</num>.<br>\n<col1>(140 creeps/14 heroes)</col1>",
    talent_421_name: "Perfect Health",
    talent_421_description:
      "For every <num>140</num> damage taken, the maximum health increases by an additional <num>2.04</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(14000 damage)</col1>",
    talent_422_name: "Liberated Strength",
    talent_422_description:
      "For each creature killed, the strength increases by an additional <num>0.06</num>, and for killing a hero — by <num>0.6</num>.<br>The total bonus cannot be more than <num>%s</num>.<br><col1>(150 creeps/15 Heroes)</col1>",
    talent_423_name: "Dedication",
    talent_423_description:
      "For every <num>270</num> damage taken, the maximum health increases by an additional <num>12</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(12150 damage)</col1>",
    talent_424_name: "Zealous Defense",
    talent_424_description:
      "For every <num>260</num> damage received, the Resistance increases by an additional <num>0.25</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(13000 damage)</col1>",
    talent_425_name: "Manifestation of Will",
    talent_425_description:
      "For every <num>260</num> damage received, the Will increases by an additional <num>0.25</num>.<br>\nthe sum bonus cannot be greater than <num>%s</num>.<br>\n<col1>(13000 damage)</col1>",
    talent_426_name: "Cunning",
    talent_426_description:
      "The Hero's cunning increases by <num>0.06</num> every time an active talent is applied nearby.<br>\npridelnaya total increase - <num>%s</num>.<br>\n<col1>(209 activations)</col1><br > <br>\nHe can be installed together with the talent <tn>Victory star</tn>",
    ...
    talent_453_description:
      "By creating a scroll in the workshop, the hero receives <prime>85</prime>.",
    ...
    talent_490_name:
      "The excitement of a bomber<font color=#FFFFFF> ⌛️80</font>",
    ...
    talent_566_name:
      "The superiority of health<font color=#FFFFFF> ⌛️60</font>",
    ...
    talent_567_name:
      "The superiority of Cunning<font color=#FFFFFF> ⌛️60</font>",
    ...
    talent_628_name:
      "The Reward of the champion<font color=#FFFFFF> ⌛️90</font>",
    ...
    talent_632_name:
      "The Power of the destroyer<font color=#FFFFFF> ⌛️180</font>",
    ...
    talent_646_description:
      "Reduces the Portal recovery time for the entire team by <num>8</num> seconds.",
    ...
    talent_765_description:
      "<num>defensive</num><br><br>When activated, the hero becomes invulnerable to physical damage for 2 seconds.",
