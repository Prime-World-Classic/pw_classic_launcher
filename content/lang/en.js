export const en = {
  ...
  word: {
    ...
    titleСhildren18_1: 'Karma - reflects player behavior and their "value" in combat.',
    titleСhildren18_2: 'It increases or decreases based on your performance in battles.',
    titleСhildren18_3: 'Current threshold: {karma}',
    ...
    nicknameChangeReadyNow: 'Nickname can be changed now',
    nicknameChangeRemaining: 'Time until next nickname change: {time}',
    nicknameTimeDayShort: 'd',
    nicknameTimeHourShort: 'h',
    nicknameTimeMinuteShort: 'm',
    ...
    statRegenHealth: 'Health regeneration',
    statRegenEnergy: 'Energy regeneration',
    statStealHealth: 'Health steal',
    ...
    buildSettingsSetSortMode: 'Set sorting',
    buildSettingsSetSortModeDefault: 'Default',
    buildSettingsSetSortModePopular: 'By popularity',
    ...
    buildSettingsHighlightHue: 'Highlight color',
    buildSettingsHighlightBorder: 'Highlight border',
    buildSettingsHighlightReset: 'Reset highlight look',
    buildStatsHighlightedTalentsCountTitle: 'Number of highlighted talents.',
    ...
    voiceReconnectingAttempt: 'reconnecting {attempt}',
    ...
    titleheroes: 'Heroes',
    castleHeroFilterPlaceholder: 'Hero name',
    ...
    titleSortSetsIntoColumn: 'LMB - Sort talents in build',
    sortSetsRmbMirrorBuild: 'RMB - Mirror build + sort',
    titleActiveTalents: 'Active talents',
    titleTheRed: 'The red',
    titleTheOrange: 'The orange',
    titleThePurple: 'The purple',
    titleTheBlue: 'The blue',
    ...
    srMin: 'Strength/Intellect (to the lowest)',
    hp: 'Health',
    provorstvo: 'Agility',
    hitrost: 'Cunning',
    cunning: 'Cunning',
    ...
    volia: 'Will',
    ph: 'Agility/Cunning',
    phMin: 'Agility/Cunning (to the lowest)',
    sv: 'Stamina/Will',
    svMin: 'Stamina/Will (to the lowest)',
    razum: 'Intellect',
    sila: 'Strength',
    speedtal: '%<speedtal></speedtal>',
    srsv: 'Strength/Intellect/Stamina/Will',
    srsvMin: 'Strength/Intellect/Stamina/Will (to the lowest)',
    hpmp: 'Health/Energy',
    hpmpMin: 'Health/Energy (to the lowest)',
    ...
    htalent_151_description:
      "While sheltered in boulder form, the hero can use the Shockwave talent. Increases the hero's Health regeneration by <num>%s</num> (from Strength)",
    ...
    htalent_713_description:
      "If the hero's Strength is greater than Intellect, the honey additionally slows enemies by <num>7%</num> and deals <fiz>%s</fiz> damage per second.<br>If the hero's Intellect is greater than Strength, the honey additionally slows enemies by <num>10%</num> and deals <fiz>%s</fiz> damage per second.",
    ...
    talent_182_description: 'Hero attack with <num>25%</num> chance additionally causes <num>%s</num> <red-d>net damage</red-d>.',
