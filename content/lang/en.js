export const en = {
  ...
  word: {
    ...
    gm5: 'Challenges',
    gm6: 'Duel',
	gm1_hover: 'Borderlands\AClassic MOBA mode. Battle on a special 5x5 map. There is a mini-game at the base, crystals are located at certain places on the map. There are also mini-bosses Cat Bayun and Zmey-Gorynych, and on the river you can get additional prime in the form of a Glyph.',
    gm2_hover: 'Outpost\ABattle on a special 3x3 map. In this mode, the map is smaller, there is only one lane. Teams of heroes will be assisted by siege engines. Initial Prime is increased. When killing a hero, all talents recover 35% faster.',
