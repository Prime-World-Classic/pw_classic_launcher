    ...
    for (let item of element) {
      ...
      if (item.domaudio) {
        button.addEventListener("mouseover", () =>
          item.domaudio?.eventMouseOverCallback(),
        );

        button.addEventListener("mousedown", () =>
          item.domaudio?.eventMouseDownCallback(),
        );

        button.addEventListener("mouseup", () =>
          item.domaudio?.eventMouseUpCallback(),
        );

        button.addEventListener("input", () =>
          item.domaudio?.eventInputCallback(),
        );

        button.addEventListener("change", () =>
          item.domaudio?.eventChangeCallback(),
        );
      }
