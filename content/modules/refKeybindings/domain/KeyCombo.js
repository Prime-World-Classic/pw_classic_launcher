...
export default class KeyCombo {
  /**
   * Maximum number of keys in the combo
   * @type {number}
   * @static
   * @readonly
   */
  ...
  /**
   * Constructor for KeyCombo class.
   * @param {string[]} keys - list of keys in the combo.
   */
  constructor(keys = []) {
    if (!Array.isArray(keys)) throw new Error('Keys must be an array');
    if (keys.length > KeyCombo.#maxLength) throw new Error('Too many keys in the combo');
    this.keys = keys;
  }
